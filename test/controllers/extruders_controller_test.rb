...
class ExtrudersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extruder" do
    assert_difference("Extruder.count") do
      post extruders_url, params: { extruder: { filament_diameter: @extruder.filament_diameter, full_steps_per_rotation: @extruder.full_steps_per_rotation, gear_ratio: @extruder.gear_ratio, microsteps: @extruder.microsteps, name: @extruder.name, nozzle_diameter: @extruder.nozzle_diameter, rotation_distance: @extruder.rotation_distance } }
    end
  ...
  test "should update extruder" do
    patch extruder_url(@extruder), params: { extruder: { filament_diameter: @extruder.filament_diameter, full_steps_per_rotation: @extruder.full_steps_per_rotation, gear_ratio: @extruder.gear_ratio, microsteps: @extruder.microsteps, name: @extruder.name, nozzle_diameter: @extruder.nozzle_diameter, rotation_distance: @extruder.rotation_distance } }
