...
class PrintersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create printer" do
    assert_difference("Printer.count") do
      post printers_url, params: { printer: { name: @printer.name, print_size_x: @printer.print_size_x, print_size_y: @printer.print_size_y, print_size_z: @printer.print_size_z } }
    end
  ...
  test "should update printer" do
    patch printer_url(@printer), params: { printer: { name: @printer.name, print_size_x: @printer.print_size_x, print_size_y: @printer.print_size_y, print_size_z: @printer.print_size_z } }
